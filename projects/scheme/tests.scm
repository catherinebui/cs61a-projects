...
(define (intersecter s t)
    (cond ((or (empty? s) (empty? t)) nil)
          ((= (car s) (car t)) (cons (car t) (intersecter (cdr s) (cdr t))))
          ((< (car s) (car t)) (intersecter (cdr s) t))
          ((> (car s) (car t)) (intersecter s (cdr t))))
    )
(intersecter (list 1 8 93 4 28 40 28 823423.2 .3) '(2 3 7 38 40 3 2 6))
; expect ()

(begin '(+ x 3) 3 28 9 '(print 2))
; expect (print 2)

(begin '(+ x 3) 3 28 9 (print 2))
; expect 2

(define x (define (l s) (+ s 1)))
; expect x
...
(and (odd? 3) (even? 4) (or (+ 7 3) (/ 1 0)) (not False))
;expect #t
